...
INSERT INTO `menu` (`name`, `icon`, `url`, `serial`, `module_access`, `have_child`, `only_admin`, `only_member`, `add_ons_id`, `is_external`, `header_text`, `is_menu_manager`, `custom_page_id`) VALUES('Instagram Posting', 'fab fa-instagram', 'instagram_poster', (SELECT serial FROM menu as menu2 WHERE url='ultrapost'), '296', '0', '0', '0', 0, '0', '', '0', 0);
